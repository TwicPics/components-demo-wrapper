...
import {
  TwicWrapper,
  TwicAbstract,
} from "@twicpics/components-demo-wrapper/react";
        ...
        <div className="twic-grid">
          ...
          <div className="twic-item">
            ...
            <span>
              ...
              <span className="twic-code">mode="cover"</span>: the image fills
              the area
            </span>
          </div>
          <div className="twic-item">
            ...
            <span>
              <span className="twic-code">ratio="16/9"</span> &{" "}
              <span className="twic-code">mode="contain"</span>: the image sits
              inside the area
            </span>
          </div>
          <div className="twic-item">
